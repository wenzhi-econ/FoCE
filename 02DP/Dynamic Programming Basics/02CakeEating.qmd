...
\begin{equation}
    ...
    \end{array}\right.
    \end{aligned}
\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}ed} \\end{equation}
...
# On-the-grid solution: Discretized $W$ grid
...
# Discretized solution: Discretize both $W$ and $c$ grids
